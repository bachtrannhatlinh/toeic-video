    ...
    <div class="card" v-if="_new">
        <div class="card-body">
            ...
            <div class="forms-sample mt-2">
                ...
                <div class="form-group col-6">
                    <label>Tiêu đề bài viêt <template>(*)</template>:</label>
                    <input type="text" class="form-control" placeholder="Tiêu đề bài viết" v-model="newDt.title">
                    <template v-if="globalObjectLength(errors)">
                ...
                <div class="form-group col-6">
                    <label>Tên người tạo <template>(*)</template>:</label>
                    <input type="text" class="form-control" placeholder="Tên người tạo" v-model="newDt.createdBy">
                    <template v-if="globalObjectLength(errors)">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" placeholder="Mô tả bài viết" v-model="newDt.description">
                </div>
                <div class="form-group col-6">
