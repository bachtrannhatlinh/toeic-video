        ...
        <div class="card-body">
            ...
            <div class="forms-sample mt-2">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" placeholder="Tiêu đề bài viết" v-model="chanelData.title">
                    <template v-if="globalObjectLength(errors)">
                ...
                <div class="form-group col-6">
                    ...
                    <UploadFile :name="`chanelData.bannerStr`" @onChangeFile="changeBanner"/>
                </div>
