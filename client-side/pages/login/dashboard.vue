...
export default {
    ...
    head() {
        return {
            link: [
                { rel: 'stylesheet', href: '/dashboard-asset/css/style.css' },
                { rel: 'stylesheet', href: '/dashboard-asset/css/vendor.bundle.base.css' },
                { rel: 'stylesheet', href: '/dashboard-asset/css/materialdesignicons.min.css ' },
            ],
            script: [
                { src: '/dashboard-asset/js/vendor.bundle.base.js' },
                { src: '/dashboard-asset/js/vendor.bundle.addons.js' },
            ]
        }
    },
    data() {
