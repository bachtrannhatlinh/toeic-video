<template>
    <div class="container-fluid">
        <div class="col-sm-11 col-12 px-1 mx-auto px-sm-0 gl-video-detail">
                ...
                <div class="col-lg-8 col-12 mx-0 px-0 gl-video-detail__content pb-3">
                    <div class="pb-1 border-bottom">
                        ...
                        <div class="social d-flex">
                            <div class="view">{{ globalFormatNumber(parseInt(videoDetail.view), ".") }} Lượt xem</div>
                            <div class="like ml-auto">
                                <i class="fal fa-thumbs-up isLike"></i> {{ globalFormatNumber(parseInt(videoDetail.likes), ".") }}
                             </div>
                            <div class="save ml-3">
                    ...
                    <div class="description" v-html="videoDetail.description">
                ...
                <div class="col-lg-8 col-12 mx-0 px-0 gl-video-detail__comments py-3 border-top">
                    ...
                    <div class="py-2 user-comments">
                        <div class="d-flex">
                            ...
                            <div class="col px-0">
                                <textarea class="w-100 px-2"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="cmt">
                        ...
                        <div class="d-flex py-2 reply-comments ml-sm-5 ml-3">
                            <div class="avatar rounded-circle">
                                <a href="/video/detail" class="nuxt-link-exact-active nuxt-link-active">
                                    <img src="http://localhost:3000/images-asset/No_Image_Available.jpg" height="50px" width="50px">
                                </a>
...
export default {
    ...
    methods: {
        ...
        initVideo: function(){
            ...
            .then( response => {
                this.videoDetail = response.data.videoDetail;
            })
            .catch( response => {
