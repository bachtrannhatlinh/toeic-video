...
export default {
    ...
    head() {
        return {
            meta: [
                { hid: 'keywords', property: 'keywords', name: 'keywords', content: 'video, toeic, học tiếng anh, phim ảnh, âm nhạc' },
                { hid: 'description', property: 'description', name: 'description', content: 'Học tiếng anh bổ ích qua video âm nhạc & phim ảnh' },
                { hid: 'og:description', property: 'og:description', name: 'og:description', content: 'Học tiếng anh bổ ích qua video âm nhạc & phim ảnh' },
                { hid: 'og:title', property: 'og:title', name: 'og:title', content: 'Langadvisor' },
